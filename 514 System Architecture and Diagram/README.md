...
### System Overview 
A two-piece set of blocks set apart to measure the space in between them. Essentially measuring a distance from point A to point B. One block is a stationary reference point while the other provides a gauge reading display for the user.  
...
A figure to show how the devices communicate with eachother
